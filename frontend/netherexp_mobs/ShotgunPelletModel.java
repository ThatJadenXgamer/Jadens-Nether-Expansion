...
public class shotgun_pellet<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "shotgun_pellet"), "main");
	private final ModelPart main;

	public shotgun_pellet(ModelPart root) {
