...
public class JNEBlocks {
    ...
    public static final WoodSet CLARET_SET = WoodSet.netherBuilder("claret", JNEWoodType.CLARET)
        .withNameModifier(WoodBlockType.STEM, name -> "cerebrage_" + name)
        .withNameModifier(WoodBlockType.HYPHAE, name -> "cerebrage_" + name)
