...
public class JNEItems {
    ...
    public static final RegistrySupplier<Item> CLARET_SIGN = registerItem("claret_sign", () ->
        new SignItem(new Item.Properties().stacksTo(16), JNEBlocks.CLARET_SET.getBlock(WoodBlockType.SIGN).get(), JNEBlocks.CLARET_SET.getBlock(WoodBlockType.WALL_SIGN).get()));

    public static final RegistrySupplier<Item> CLARET_HANGING_SIGN = registerItem("claret_hanging_sign", () ->
        new HangingSignItem(JNEBlocks.CLARET_SET.getBlock(WoodBlockType.HANGING_SIGN).get(), JNEBlocks.CLARET_SET.getBlock(WoodBlockType.WALL_HANGING_SIGN).get(), new Item.Properties().stacksTo(16)));

    public static final RegistrySupplier<Item> SMOKESTALK_SIGN = registerItem("smokestalk_sign", () ->
        new SignItem(new Item.Properties().stacksTo(16), JNEBlocks.SMOKESTALK_SET.getBlock(WoodBlockType.SIGN).get(), JNEBlocks.SMOKESTALK_SET.getBlock(WoodBlockType.WALL_SIGN).get()));

    public static final RegistrySupplier<Item> SMOKESTALK_HANGING_SIGN = registerItem("smokestalk_hanging_sign", () ->
        new HangingSignItem(JNEBlocks.SMOKESTALK_SET.getBlock(WoodBlockType.HANGING_SIGN).get(), JNEBlocks.SMOKESTALK_SET.getBlock(WoodBlockType.WALL_HANGING_SIGN).get(), new Item.Properties().stacksTo(16)));
    ...
    public static final RegistrySupplier<Item> SKULL_ON_A_STICK = registerItem("skull_on_a_stick", () ->
