...
public class JNEModelLayers {
    ...
    public static final ModelLayerLocation BANSHEE_LAYER = new ModelLayerLocation(
            new ResourceLocation(NetherExp.MOD_ID, "banshee_layer"), "main");
    ...
    public static final ModelLayerLocation STAMPEDE_SADDLE_LAYER = new ModelLayerLocation(
            new ResourceLocation(NetherExp.MOD_ID, "stampede_saddle_layer"), "main");
