...
import net.jadenxgamer.netherexp.effect.ModEffects;
...
public class ModFoodComponents {
    ...
    public static final FoodComponent WARPSPORES = new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).alwaysEdible().statusEffect(new StatusEffectInstance(ModEffects.Hallucination, 200,1),0.3f).build();
}
