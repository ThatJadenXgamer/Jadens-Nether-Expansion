...
public class NetherExpClient {
    ...
    public static void registerEntityRenderers() {
        ...
        EntityRenderers.register(JNEEntityType.FALSE_CARCASS.get(), FalseCarcassRenderer::new);
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(JNEModelLayers.FALSE_CARCASS_LAYER, FalseCarcassModel::createBodyLayer);
    ...
    public static void registerEnqueuedWorkers(FMLClientSetupEvent event) {
        event.enqueueWork(() ->
    ...
    public static void registerParticles(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(JNEParticleTypes.BLACK_FLAKE.get(), BlackSnowParticle.Factory::new);
        event.registerSpriteSet(JNEParticleTypes.TRAIL_BLACK_FLAKE.get(), JNECherryParticle.Factory::new);
        ...
        event.registerSpriteSet(JNEParticleTypes.ANCIENT_WAX_CLOUD.get(), JNEPoofParticle.AncientWaxProvider::new);
    ...
    public static void registerModCompatParticles(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(JNEParticleTypes.JACKHAMMER.get(), ConsistentExplosionParticle.Factory::new);
    }
    ...
    public static void attemptLoadShader(ResourceLocation effect) {
        ...
        if (loadShaderAttempt <= 0) {
            ...
            if (!BETRAYED_SHADER.toString().equals((renderer.currentEffect().getName()))) {
                loadShaderAttempt = 12000;
                NetherExp.LOGGER.warn("Failed to load shader {}", effect);
            }
        }
    }
}
