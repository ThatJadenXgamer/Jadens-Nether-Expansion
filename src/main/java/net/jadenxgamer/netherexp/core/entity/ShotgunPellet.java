...
public class ShotgunPellet extends AbstractArrow {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (getOwner() != null) {
            entity.hurt(this.damageSources().source(JNEDamageTypes.SHOTGUN_PELLET, getOwner()), 1);
        } else entity.hurt(this.damageSources().source(JNEDamageTypes.SHOTGUN_PELLET), 1);
