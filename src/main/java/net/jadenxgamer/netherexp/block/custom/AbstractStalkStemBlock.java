...
public abstract class AbstractStalkStemBlock
    ...
    protected AbstractStalkStemBlock(AbstractBlock.Settings settings, Direction growthDirection, VoxelShape outlineShape, boolean tickWater, double growthChance) {
    ...
    @Override
    protected net.jadenxgamer.netherexp.block.custom.AbstractStalkStemBlock getStem() {
        return this;
    }
}
