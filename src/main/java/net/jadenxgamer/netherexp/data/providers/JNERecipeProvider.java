...
public class JNERecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        // ## Soul Slate
        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEBlocks.PALE_SOUL_SLATE.get(), 4)
                .define('S', JNEBlocks.SOUL_SLATE.get())
                .define('N', Blocks.NETHERRACK)
                .pattern(" S ")
                .pattern("SNS")
                .pattern(" S ")
                .unlockedBy("has_soul_slate", has(JNEBlocks.SOUL_SLATE.get()))
                .save(output);

        slab(output, RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_SLATE_SLAB.get(), JNEBlocks.SOUL_SLATE.get());
        stairBuilder(JNEBlocks.SOUL_SLATE_STAIRS.get(), Ingredient.of(JNEBlocks.SOUL_SLATE.get()))
                .unlockedBy("has_soul_slate", has(JNEBlocks.SOUL_SLATE.get()))
                .save(output);
        ...
        bricksBuilder(JNEBlocks.SOUL_SLATE_BRICKS.get(), JNEBlocks.ETCHED_SOUL_SLATE_BRICKS.get())
                .unlockedBy("has_soul_slate", has(JNEBlocks.SOUL_SLATE.get()))
                .save(output, "netherexp:soul_slate_bricks_from_etched");

        slab(output, RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_SLATE_BRICK_SLAB.get(), JNEBlocks.SOUL_SLATE_BRICKS.get());
        stairBuilder(JNEBlocks.SOUL_SLATE_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.SOUL_SLATE_BRICKS.get()))
                .unlockedBy("has_soul_slate_bricks", has(JNEBlocks.SOUL_SLATE_BRICKS.get()))
                .save(output);
        ...
        bricksBuilder(JNEBlocks.SOUL_SLATE_TILES.get(), JNEBlocks.ETCHED_SOUL_SLATE_TILES.get())
                .unlockedBy("has_soul_slate", has(JNEBlocks.SOUL_SLATE.get()))
                .save(output, "netherexp:soul_slate_tiles_from_etched");

        slab(output, RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_SLATE_TILE_SLAB.get(), JNEBlocks.SOUL_SLATE_TILES.get());
        stairBuilder(JNEBlocks.SOUL_SLATE_TILE_STAIRS.get(), Ingredient.of(JNEBlocks.SOUL_SLATE_TILES.get()))
                .unlockedBy("has_soul_slate_tiles", has(JNEBlocks.SOUL_SLATE_TILES.get()))
                .save(output);
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.SOUL_CANDLE.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.DISCERNMENT_GLASS.get(), 2)
                .define('Q', Items.QUARTZ)
                .define('S', JNEBlocks.SOUL_GLASS.get())
                .pattern(" Q ")
                .pattern("QSQ")
                .pattern(" Q ")
                .unlockedBy("has_soul_glass", has(JNEBlocks.SOUL_GLASS.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.ECTO_SOUL_SAND.get(), 2)
                .define('W', Blocks.SOUL_SAND)
                .define('S', JNEItems.WRAITHING_FLESH.get())
                .pattern("WS")
                .pattern("SW")
                .unlockedBy("has_wraithing_fless", has(JNEItems.WRAITHING_FLESH.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_MAGMA_BLOCK.get(), 4)
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_SOIL_LAYER.get(), 24)
                .define('#', Blocks.SOUL_SOIL)
                .pattern("###")
                .unlockedBy("has_soul_soil", has(Blocks.SOUL_SOIL))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.SOUL_SOIL)
                .requires(JNEBlocks.SOUL_SOIL_LAYER.get(), 9)
                .unlockedBy("has_soul_soil", has(Blocks.SOUL_SOIL))
                .save(output, "netherexp:soul_soil_from_soul_soil_layer");

        twoByTwoPacker(output, JNEBlocks.BLACK_ICE.get(), JNEBlocks.BLACK_ICICLE.get(), 2);
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SOUL_PERMAFROST.get(), 4)
                .define('A', JNEBlocks.BLACK_ICE.get())
                .define('B', Blocks.SOUL_SOIL)
                .pattern("AB")
                .pattern("BA")
                .unlockedBy("has_black_ice", has(JNEBlocks.BLACK_ICE.get()))
                .save(output);

        // ## Smooth Netherrack
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SMOOTH_NETHERRACK.get(), 4)
        ...
        stairBuilder(JNEBlocks.SMOOTH_NETHERRACK_STAIRS.get(), Ingredient.of(JNEBlocks.SMOOTH_NETHERRACK.get()))
                .unlockedBy("has_smooth_netherrack", has(JNEBlocks.SMOOTH_NETHERRACK.get()))
                .save(output);
        ...
        stairBuilder(JNEBlocks.NETHERRACK_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.NETHERRACK_BRICKS.get()))
                .unlockedBy("has_netherrack_bricks", has(JNEBlocks.NETHERRACK_BRICKS.get()))
                .save(output);
        ...
        stairBuilder(JNEBlocks.POLISHED_BASALT_STAIRS.get(), Ingredient.of(Blocks.POLISHED_BASALT))
        ...
        stairBuilder(JNEBlocks.POLISHED_BASALT_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.POLISHED_BASALT_BRICKS.get()))
                .unlockedBy("has_polished_basalt_bricks", has(JNEBlocks.POLISHED_BASALT_BRICKS.get()))
                .save(output);
        ...
        cutBuilder(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.CUT_NETHERITE_BLOCK.get(), Ingredient.of(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .group("cut_netherite_block")
                .unlockedBy("has_netherite_plated_block", has(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.CUT_NETHERITE_SLAB.get(), Ingredient.of(JNEBlocks.CUT_NETHERITE_BLOCK.get()))
                .group("cut_netherite_slab")
                .unlockedBy("has_netherite_plated_block", has(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        stairBuilder(JNEBlocks.CUT_NETHERITE_STAIRS.get(), Ingredient.of(JNEBlocks.CUT_NETHERITE_BLOCK.get()))
                .group("cut_netherite_stairs")
                .unlockedBy("has_netherite_plated_block", has(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        pillarBuilder(JNEBlocks.CUT_NETHERITE_PILLAR.get(), JNEBlocks.CUT_NETHERITE_BLOCK.get())
                .unlockedBy("has_netherite_plated_block", has(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        grateBuilder(JNEBlocks.NETHERITE_GRATE.get(), JNEBlocks.NETHERITE_PLATED_BLOCK.get())
                .group("netherite_grate")
                .unlockedBy("has_netherite_plated_block", has(JNEBlocks.NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        // ## Rusty Netherite
        cutBuilder(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.RUSTY_CUT_NETHERITE_BLOCK.get(), Ingredient.of(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .group("cut_netherite_block")
                .unlockedBy("has_rusty_netherite_plated_block", has(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.RUSTY_CUT_NETHERITE_SLAB.get(), Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_BLOCK.get()))
                .group("cut_netherite_slab")
                .unlockedBy("has_rusty_netherite_plated_block", has(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        stairBuilder(JNEBlocks.RUSTY_CUT_NETHERITE_STAIRS.get(), Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_BLOCK.get()))
                .group("cut_netherite_stairs")
                .unlockedBy("has_rusty_netherite_plated_block", has(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        pillarBuilder(JNEBlocks.RUSTY_CUT_NETHERITE_PILLAR.get(), JNEBlocks.RUSTY_CUT_NETHERITE_BLOCK.get())
                .unlockedBy("has_rusty_netherite_plated_block", has(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .save(output);

        grateBuilder(JNEBlocks.RUSTY_NETHERITE_GRATE.get(), JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get())
                .group("netherite_grate")
                .unlockedBy("has_rusty_netherite_plated_block", has(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()))
                .save(output);
        ...
        nineBlockStorageRecipes(
                ...
                JNEBlocks.MAGMA_CREAM_BLOCK.get(),
                "netherexp:magma_cream_block",
                null,
                "minecraft:magma_cream_from_magma_cream_block",
                null);
        ...
        // ## Nether Bricks
        transformEightBuilder(Blocks.RED_NETHER_BRICKS, Blocks.NETHER_BRICKS, Blocks.NETHER_WART_BLOCK)
                .group("colored_nether_bricks")
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.RED_MIXED_NETHER_BRICKS.get(), 4)
        ...
        // ## Blue Nether Bricks
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.BLUE_MIXED_NETHER_BRICKS.get(), 4)
                .define('A', Blocks.NETHER_BRICKS)
                .define('B', JNEBlocks.BLUE_NETHER_BRICKS.get())
                .pattern("AB")
                .pattern("BA")
                .unlockedBy("has_blue_nether_bricks", has(JNEBlocks.BLUE_NETHER_BRICKS.get()))
                .save(output);

        transformEightBuilder(JNEBlocks.BLUE_NETHER_BRICKS.get(), Blocks.NETHER_BRICKS, Blocks.WARPED_WART_BLOCK)
                .group("colored_nether_bricks")
                .unlockedBy("has_nether_bricks", has(Blocks.NETHER_BRICKS))
                .save(output);

        slab(output, RecipeCategory.BUILDING_BLOCKS, JNEBlocks.BLUE_NETHER_BRICK_SLAB.get(), JNEBlocks.BLUE_NETHER_BRICKS.get());
        stairBuilder(JNEBlocks.BLUE_NETHER_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.BLUE_NETHER_BRICKS.get()))
                .unlockedBy("has_blue_nether_bricks", has(JNEBlocks.BLUE_NETHER_BRICKS.get()))
                .save(output);
        ...
        // ## Farming & Food
        ShapedRecipeBuilder
                .shaped(RecipeCategory.FOOD, JNEBlocks.NETHER_PIZZA.get())
                .define('H', JNETags.Items.COOKED_HOGHAM)
                .define('W', JNEBlocks.WARPED_WART.get())
                .define('C', JNEItems.GLOWCHEESE.get())
                .define('B', Items.BREAD)
                .define('N', Items.NETHER_WART)
                .pattern("HWH")
                .pattern("CCC")
                .pattern("BNB")
                .unlockedBy("has_glowcheese", has(JNEItems.GLOWCHEESE.get()))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, JNEBlocks.WRAITHING_LESION.get())
                .requires(Items.GHAST_TEAR, 3)
                .requires(JNEItems.WRAITHING_FLESH.get(), 6)
                .unlockedBy("has_wraithing_flesh", has(JNEItems.WRAITHING_FLESH.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.GHOUL_O_LANTERN.get())
                .define('S', JNEBlocks.CARVED_SORROWSQUASH.get())
                .define('T', Items.SOUL_TORCH)
                .pattern("S")
                .pattern("T")
                .unlockedBy("has_carved_sorrowsquash", has(JNEBlocks.CARVED_SORROWSQUASH.get()))
                .save(output);

        // ## Ivy
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.TWISTING_IVY.get())
                .requires(Blocks.TWISTING_VINES)
                .group("ivy_blocks")
                .unlockedBy("has_twisting_vines", has(Blocks.TWISTING_VINES))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.WEEPING_IVY.get())
                .requires(Blocks.WEEPING_VINES)
                .group("ivy_blocks")
                .unlockedBy("has_weeping_vines", has(Blocks.WEEPING_VINES))
                .save(output);

        // ## Sporeshrooms and Geysers
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.SOULED_GEYSER.get())
                .define('B', JNEBlocks.SOUL_SLATE.get())
                .define('G', JNEBlocks.SOULED_GEYSER.get())
                .define('L', Items.LAVA_BUCKET)
                .pattern("B")
                .pattern("G")
                .pattern("L")
                .unlockedBy("has_souled_geyser", has(JNEBlocks.SOULED_GEYSER.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.BASALTIC_GEYSER.get())
                .define('B', Blocks.BASALT)
                .define('G', JNEBlocks.BASALTIC_GEYSER.get())
                .define('L', Items.LAVA_BUCKET)
                .pattern("B")
                .pattern("G")
                .pattern("L")
                .unlockedBy("has_basaltic_geyser", has(JNEBlocks.BASALTIC_GEYSER.get()))
                .save(output);

        // ## Blackstone
        pillar(output, JNEBlocks.POLISHED_BLACKSTONE_PILLAR.get(), Blocks.POLISHED_BLACKSTONE);
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.POLISHED_BLACKSTONE_FENCE.get(), 6)
        ...
        stairBuilder(JNEBlocks.WEEPING_POLISHED_BLACKSTONE_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.WEEPING_POLISHED_BLACKSTONE_BRICKS.get()))
                .unlockedBy("has_weeping_polished_blackstone_bricks", has(JNEBlocks.WEEPING_POLISHED_BLACKSTONE_BRICKS.get()))
                .save(output);
        ...
        stairBuilder(JNEBlocks.TWISTING_POLISHED_BLACKSTONE_BRICK_STAIRS.get(), Ingredient.of(JNEBlocks.TWISTING_POLISHED_BLACKSTONE_BRICKS.get()))
                .unlockedBy("has_twisting_polished_blackstone_bricks", has(JNEBlocks.TWISTING_POLISHED_BLACKSTONE_BRICKS.get()))
                .save(output);
        ...
        // ## Bones
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.SKELETON_SKULL_CANDLE.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.SOUL_SKELETON_SKULL_CANDLE.get())
                .define('S', Items.SKELETON_SKULL)
                .define('C', JNEBlocks.SOUL_CANDLE.get())
                .pattern("S")
                .pattern("C")
                .unlockedBy("has_soul_fire_base_block", has(ItemTags.SOUL_FIRE_BASE_BLOCKS))
                .save(output);
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS, JNEBlocks.ANCIENT_SKELETON_SKULL_CANDLE.get())
                .requires(Items.SKELETON_SKULL)
                .requires(JNEBlocks.ANCIENT_CANDLE.get())
                .unlockedBy("has_ancient_wax", has(JNEItems.ANCIENT_WAX.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.BONE_PIKE.get(), 2)
                .define('#', Items.BONE)
                .pattern("#")
                .pattern("#")
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.BONE_FENCE.get(), 4)
                .define('#', Items.BONE)
                .define('S', Items.STRING)
                .pattern("#S#")
                .pattern("#S#")
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.SKULL_BLOCK.get())
                .define('#', JNEBlocks.STACKED_BONE_SLAB.get())
                .pattern("#")
                .pattern("#")
                .unlockedBy("has_stacked_bones", has(JNEBlocks.STACKED_BONES.get()))
                .save(output);
        ...
        stairBuilder(JNEBlocks.STACKED_BONE_STAIRS.get(), Ingredient.of(JNEBlocks.STACKED_BONES.get()))
                .unlockedBy("has_stacked_bones", has(JNEBlocks.STACKED_BONES.get()))
                .save(output);

        // ## Wither Bones
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.WITHER_BONE_BLOCK.get(), 2)
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, JNEBlocks.WITHER_SKULL_BLOCK.get())
                .define('#', JNEBlocks.STACKED_WITHER_BONE_SLAB.get())
                .pattern("#")
                .pattern("#")
                .unlockedBy("has_wither_stacked_bones", has(JNEBlocks.STACKED_WITHER_BONES.get()))
                .save(output);
        ...
        stairBuilder(JNEBlocks.STACKED_WITHER_BONE_STAIRS.get(), Ingredient.of(JNEBlocks.STACKED_WITHER_BONES.get()))
                .unlockedBy("has_stacked_bones", has(JNEBlocks.STACKED_WITHER_BONES.get()))
                .save(output);
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEBlocks.INSCRIBED_PANEL.get(), 4)
                .define('S', JNEBlocks.SOUL_SLATE_BRICKS.get())
                .define('W', JNEItems.WRAITHING_FLESH.get())
                .pattern(" S ")
                .pattern("SWS")
                .pattern(" S ")
                .unlockedBy("has_soul_slate_bricks", has(JNEBlocks.SOUL_SLATE_BRICKS.get()))
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEBlocks.SHOTGUN_BARREL.get(), 2)
                .define('B', Blocks.BONE_BLOCK)
                .define('R', Items.REDSTONE)
                .define('S', JNEItems.SHOTGUN_CORE.get())
                .define('N', JNEItems.STRIDITE.get())
                .pattern("BBB")
                .pattern("RSR")
                .pattern("NNN")
                .unlockedBy("has_shotgun_core", has(JNEItems.SHOTGUN_CORE.get()))
                .save(output);

        // ## Ancient Fire
        transformEight(output, JNEBlocks.ANCIENT_WAX_BLOCK.get(), Blocks.HONEYCOMB_BLOCK, JNEItems.ANCIENT_WAX.get());
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEItems.ANCIENT_TORCH.get(), 4)
                .define('X', Ingredient.of(Items.COAL, Items.CHARCOAL, JNEItems.FOSSIL_FUEL.get()))
                .define('#', Items.STICK)
                .define('A', JNEItems.ANCIENT_WAX.get())
                .pattern("X")
                .pattern("#")
                .pattern("A")
                .unlockedBy("has_ancient_wax", has(JNEItems.ANCIENT_WAX.get()))
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.ANCIENT_LANTERN.get())
                .define('#', JNEItems.ANCIENT_TORCH.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.ANCIENT_CAMPFIRE.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, JNEBlocks.ANCIENT_CANDLE.get(), 6)
                .define('S', Items.STRING)
                .define('A', JNEItems.ANCIENT_WAX.get())
                .pattern("S")
                .pattern("A")
        ...
        // # Items
        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.RIFT_ARMOR_TRIM_SMITHING_TEMPLATE.get(), 2)
                .define('#', Items.DIAMOND)
                .define('C', Blocks.CRYING_OBSIDIAN)
                .define('S', JNEItems.RIFT_ARMOR_TRIM_SMITHING_TEMPLATE.get())
                .pattern("#S#")
                .pattern("#C#")
                .pattern("###")
                .unlockedBy("has_rift_armor_trim_smithing_template", has(JNEItems.RIFT_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .showNotification(true)
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.SPIRIT_ARMOR_TRIM_SMITHING_TEMPLATE.get(), 2)
                .define('#', Items.DIAMOND)
                .define('C', JNEBlocks.SOUL_SLATE.get())
                .define('S', JNEItems.SPIRIT_ARMOR_TRIM_SMITHING_TEMPLATE.get())
                .pattern("#S#")
                .pattern("#C#")
                .pattern("###")
                .unlockedBy("has_spirit_armor_trim_smithing_template", has(JNEItems.SPIRIT_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .showNotification(true)
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.VALOR_ARMOR_TRIM_SMITHING_TEMPLATE.get(), 2)
                .define('#', Items.DIAMOND)
                .define('C', JNEBlocks.PALE_SOUL_SLATE.get())
                .define('S', JNEItems.VALOR_ARMOR_TRIM_SMITHING_TEMPLATE.get())
                .pattern("#S#")
                .pattern("#C#")
                .pattern("###")
                .unlockedBy("has_valor_armor_trim_smithing_template", has(JNEItems.VALOR_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .showNotification(true)
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.PUMP_CHARGE_UPGRADE_SMITHING_TEMPLATE.get(), 2)
                .define('#', Items.BONE_BLOCK)
                .define('F', JNEItems.TREACHEROUS_FLAME.get())
                .define('S', JNEItems.PUMP_CHARGE_UPGRADE_SMITHING_TEMPLATE.get())
                .pattern("#S#")
                .pattern("#F#")
                .pattern("###")
                .unlockedBy("has_pump_charge_upgrade_smithing_template", has(JNEItems.PUMP_CHARGE_UPGRADE_SMITHING_TEMPLATE.get()))
                .showNotification(true)
                .save(output);
        ...
        nineBlockStorageRecipes(
                output,
                RecipeCategory.MISC,
                JNEItems.LIGHTSPORES.get(),
                RecipeCategory.DECORATIONS,
                Blocks.SHROOMLIGHT,
                "minecraft:shroomlight_from_lightspores",
                null,
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, JNEItems.GLOWCHEESE.get(), 3)
                .requires(JNEItems.LIGHTSPORES.get())
                .requires(JNEItems.NIGHTSPORES.get())
                .requires(Items.MILK_BUCKET)
                .unlockedBy("has_glowspores", has(JNETags.Items.GLOWSPORES))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, JNEItems.WRAITHING_FLESH.get())
                .requires(Items.ROTTEN_FLESH)
                .requires(JNEItems.BANSHEE_POWDER.get())
                .unlockedBy("has_banshee_powder", has(JNEItems.BANSHEE_POWDER.get()))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, JNEItems.PHASMO_SHARD.get(), 2)
                .requires(JNEItems.BANSHEE_POWDER.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.COMBAT, JNEItems.PHASMO_ARROW.get(), 2)
                .define('#', JNEItems.PHASMO_SHARD.get())
                .define('X', Items.ARROW)
                .pattern(" # ")
                .pattern("#X#")
                .pattern(" # ")
                .unlockedBy("has_phasmo_shard", has(JNEItems.PHASMO_SHARD.get()))
                .save(output);

        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BREWING, JNEItems.BANSHEE_POWDER.get(), 2)
                .requires(JNEItems.BANSHEE_ROD.get())
                .unlockedBy("has_banshee_rod", has(JNEItems.BANSHEE_ROD.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.WILL_O_WISP.get(), 4)
                .define('B', JNEItems.BANSHEE_POWDER.get())
                .define('#', JNEItems.WISP_BOTTLE.get())
                .pattern(" B ")
                .pattern("B#B")
                .pattern(" B ")
                .unlockedBy("has_wisp_bottle", has(JNEItems.WISP_BOTTLE.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.MISC, JNEItems.NETHERITE_PLATING.get(), 64)
                .define('G', Items.GOLD_INGOT)
                .define('S', JNEItems.STRIDITE.get())
                .define('N', Items.NETHERITE_SCRAP)
                .pattern("GS")
                .pattern("SN")
                .unlockedBy("has_stridite", has(JNEItems.STRIDITE.get()))
                .save(output);

        ShapedRecipeBuilder
                .shaped(RecipeCategory.COMBAT, JNEItems.SHOTGUN_FIST.get())
                .define('N', Items.NETHERITE_INGOT)
                .define('#', JNEItems.SHOTGUN_CORE.get())
                .define('S', Items.SKELETON_SKULL)
                .pattern("N#S")
                .pattern("N  ")
                .unlockedBy("has_shotgun_core", has(JNEItems.SHOTGUN_CORE.get()))
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.TOOLS, JNEItems.SKULL_ON_A_STICK.get())
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.FOOD, JNEItems.ROASTED_BONE.get(), 3)
                .define('C', JNEItems.CEREBRAGE.get())
                ...
                .pattern("###")
                .pattern(" F ")
                .unlockedBy("has_cooked_hogham", has(JNETags.Items.COOKED_HOGHAM))
                .save(output);

        // # Minecraft
        oneToOneConversionRecipe(output, Items.QUARTZ, Blocks.QUARTZ_BLOCK, "quartz", 4);
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.MAGMA_BLOCK, 4)
                .define('A', Items.MAGMA_CREAM)
        ...
        ShapelessRecipeBuilder
                ...
                .requires(JNEItems.FOSSIL_FUEL.get())
                .unlockedBy("has_fossil_fuel", has(JNEItems.FOSSIL_FUEL.get()))
                .group("brown_dye")
                .save(output, getConversionRecipeName(Items.BROWN_DYE, JNEItems.FOSSIL_FUEL.get()));
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, Blocks.TORCH, 4)
                .define('X', JNEItems.FOSSIL_FUEL.get())
                .define('#', Items.STICK)
                .pattern("X")
                .pattern("#")
                .unlockedBy("has_fossil_fuel", has(JNEItems.FOSSIL_FUEL.get()))
                .save(output, "torch_from_fossil_fuel");
        ...
        ShapedRecipeBuilder
                ...
                .pattern("S")
                .unlockedBy("has_fossil_fuel", has(JNEItems.FOSSIL_FUEL.get()))
                .save(output, "soul_torch_from_fossil_fuel");

        // Cooking
        // # Blocks
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.SOUL_SLATE_BRICKS.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_NETHERITE_PLATED_BLOCK.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_BLOCK.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_SLAB.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_STAIRS.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_CUT_NETHERITE_PILLAR.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder.smelting(
                Ingredient.of(JNEBlocks.RUSTY_NETHERITE_GRATE.get()),
                RecipeCategory.BUILDING_BLOCKS,
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(JNEItems.HOGHAM.get()), RecipeCategory.FOOD, JNEItems.COOKED_HOGHAM.get(), 0.35f, 200)
                .unlockedBy("has_hogham", has(JNEItems.HOGHAM.get()))
                .save(output);

        SimpleCookingRecipeBuilder
                .campfireCooking(Ingredient.of(JNEItems.HOGHAM.get()), RecipeCategory.FOOD, JNEItems.COOKED_HOGHAM.get(), 0.35f, 600)
                .unlockedBy("has_hogham", has(JNEItems.HOGHAM.get()))
                .save(output, "netherexp:cooked_hogham_from_campfire_cooking");

        SimpleCookingRecipeBuilder
                .smoking(Ingredient.of(JNEItems.HOGHAM.get()), RecipeCategory.FOOD, JNEItems.COOKED_HOGHAM.get(), 0.35f, 100)
                .unlockedBy("has_hogham", has(JNEItems.HOGHAM.get()))
                .save(output, "netherexp:cooked_hogham_from_smoking");

        // Smithing
        SmithingTrimRecipeBuilder
                .smithingTrim(
                        Ingredient.of(JNEItems.RIFT_ARMOR_TRIM_SMITHING_TEMPLATE.get()),
                        Ingredient.of(ItemTags.TRIMMABLE_ARMOR),
                        Ingredient.of(ItemTags.TRIM_MATERIALS),
                        RecipeCategory.COMBAT)
                .unlocks("has_rift_armor_trim", has(JNEItems.RIFT_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(NetherExp.MOD_ID, "rift_armor_trim"));

        SmithingTrimRecipeBuilder
                .smithingTrim(
                        Ingredient.of(JNEItems.SPIRIT_ARMOR_TRIM_SMITHING_TEMPLATE.get()),
                        Ingredient.of(ItemTags.TRIMMABLE_ARMOR),
                        Ingredient.of(ItemTags.TRIM_MATERIALS),
                        RecipeCategory.COMBAT)
                .unlocks("has_spirit_armor_trim", has(JNEItems.SPIRIT_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(NetherExp.MOD_ID, "spirit_armor_trim"));

        SmithingTrimRecipeBuilder
                .smithingTrim(
                        Ingredient.of(JNEItems.VALOR_ARMOR_TRIM_SMITHING_TEMPLATE.get()),
                        Ingredient.of(ItemTags.TRIMMABLE_ARMOR),
                        Ingredient.of(ItemTags.TRIM_MATERIALS),
                        RecipeCategory.COMBAT)
                .unlocks("has_valor_armor_trim", has(JNEItems.VALOR_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(NetherExp.MOD_ID, "valor_armor_trim"));

        SmithingTransformRecipeBuilder
                .smithing(
                        Ingredient.of(JNEItems.PUMP_CHARGE_UPGRADE_SMITHING_TEMPLATE.get()),
                        Ingredient.of(JNEItems.SHOTGUN_FIST.get()),
                        Ingredient.of(JNEItems.TREACHEROUS_FLAME.get()),
                        RecipeCategory.COMBAT,
                        JNEItems.PUMP_CHARGE_SHOTGUN.get())
                .unlocks("has_pump_charge_upgrade_smithing_template", has(JNEItems.PUMP_CHARGE_UPGRADE_SMITHING_TEMPLATE.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(NetherExp.MOD_ID, "pump_charge_shotgun"));
    ...
    /**
     * Generates a stone cutter recipe, with preconfigured advancements
     * @param output propagated recipe output
     * @param ingredient the base block
    ...
    protected static void pillar(RecipeOutput output, ItemLike pillar, ItemLike block) {
        pillarBuilder(pillar, block).unlockedBy(getHasName(block), has(block)).save(output);
    }
    ...
    protected static RecipeBuilder pillarBuilder(ItemLike pillar, ItemLike block) {
        return ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, pillar, 2).define('#', block).pattern("#").pattern("#");
    }
    ...
    protected static void bricks(RecipeOutput output, ItemLike bricks, ItemLike block) {
        bricksBuilder(bricks, block).unlockedBy(getHasName(block), has(block)).save(output);
    }
    ...
    protected static RecipeBuilder bricksBuilder(ItemLike bricks, ItemLike block) {
        return ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, bricks, 4).define('#', block).pattern("##").pattern("##");
    }
    ...
    protected static void twoByTwoPacker(RecipeOutput output, ItemLike packed, ItemLike unpacked, int count) {
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, packed, count)
                .define('#', unpacked)
                .pattern("##")
                .pattern("##")
    ...
    protected static void etched(RecipeOutput output, ItemLike etched, ItemLike block) {
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, etched, 8)
                .define('#', block)
                .pattern("###")
                .pattern("# #")
                .pattern("###")
    ...
    protected static void transformEight(RecipeOutput output, ItemLike result, ItemLike block, ItemLike catalyst) {
        transformEightBuilder(result, block, catalyst).unlockedBy(getHasName(catalyst), has(catalyst)).save(output);
    }
    ...
    protected static void burningSkull(RecipeOutput output, ItemLike burningSkull, ItemLike skullBlock, ItemLike torch) {
        ShapedRecipeBuilder
                .shaped(RecipeCategory.DECORATIONS, burningSkull)
                .define('#', skullBlock)
                .define('T', torch)
                .pattern("#")
                .pattern("T")
