...
public interface JNETagProviders {
    ...
    final class Block extends BlockTagsProvider {
    ...
    final class DamageType extends DamageTypeTagsProvider {

        public DamageType(PackOutput arg, CompletableFuture<HolderLookup.Provider> completableFuture, @Nullable ExistingFileHelper existingFileHelper) {
