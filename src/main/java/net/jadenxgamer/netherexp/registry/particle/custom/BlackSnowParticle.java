...
public class BlackSnowParticle extends TextureSheetParticle {
    ...
    public BlackSnowParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet pSpriteSet) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new BlackSnowParticle(level, x, y, z, spriteSet);
        }
    }
}
