...
public class CavernsAndChasmsCompat {
    ...
    public static class Blocks {
        ...
        public static final Supplier<Block> TREACHEROUS_BRAZIER = registerBlock("treacherous_brazier", () -> ElysiumReflection.createBlock()
                        .className("com.teamabnormals.caverns_and_chasms.common.block.BrazierBlock")
