...
public class ModBlocks {
    ...
    public static final Block SOUL_SLATE = registerBlock("soul_slate",
            new Block(FabricBlockSettings.of().strength(4f).requiresTool().sounds(ModSoundEvents.SOUL_SLATE)));
    ...
    public static final Block SOUL_SLATE_BRICKS = registerBlock("soul_slate_bricks",
            new Block(FabricBlockSettings.of().strength(2f).requiresTool().sounds(ModSoundEvents.SOUL_SLATE_BRICKS)));
    ...
    public static final Block SOUL_CANDLE = registerBlock("soul_candle",
            new SoulCandleBlock(FabricBlockSettings.of().noCollision().nonOpaque().strength(0.1f).sounds(ModSoundEvents.SOUL_CANDLE).luminance(SoulCandleBlock.STATE_TO_LUMINANCE)));

    // Soul Decorations

    public static final Block SOUL_GLASS = registerBlock("soul_glass",
            new SoulGlassBlock(FabricBlockSettings.copyOf(Blocks.GLASS).strength(0.3f, 1200.0f).sounds(BlockSoundGroup.GLASS)));

    public static final Block SOUL_SWIRLS = registerBlock("soul_swirls",
            new SoulSwirlsBlock(7,3,FabricBlockSettings.of().noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS)));
    ...
    public static final Block SORROWSQUASH = registerBlock("sorrowsquash",
            new SorrowsquashBlock(FabricBlockSettings.of().strength(1.0f).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block CARVED_SORROWSQUASH = registerBlock("carved_sorrowsquash",
            new CarvedSorrowsquashBlock(FabricBlockSettings.of().strength(1.0f).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block GHOUL_O_LANTERN = registerBlock("ghoul_o_lantern",
            new CarvedSorrowsquashBlock(FabricBlockSettings.of().strength(1.0f).luminance(15).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block SOUL_GHOUL_O_LANTERN = registerBlock("soul_ghoul_o_lantern",
            new CarvedSorrowsquashBlock(FabricBlockSettings.copyOf(ModBlocks.GHOUL_O_LANTERN).sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block ENIGMA_FLESH = registerBlock("enigma_flesh",
            new PillarBlock(FabricBlockSettings.of().strength(1.8f).sounds(BlockSoundGroup.FUNGUS)));

    public static final Block STRANGE_ENIGMA_FLESH = registerBlock("strange_enigma_flesh",
            new StrangeEnigmaFleshBlock(FabricBlockSettings.copyOf(ModBlocks.ENIGMA_FLESH).luminance(12).sounds(BlockSoundGroup.FUNGUS)));

    public static final Block ENIGMA_CROWN = registerBlock("enigma_crown",
            new EnigmaCrownBlock(FabricBlockSettings.of().strength(0.2f).sounds(BlockSoundGroup.FUNGUS)));

    public static final Block ENIGMA_SHELF = registerBlock("enigma_shelf",
            new DeadCoralWallFanBlock(FabricBlockSettings.of().noCollision().breakInstantly().sounds(BlockSoundGroup.FUNGUS)));

    // Claret Woodset

    public static final Block CLARET_STEM = registerBlock("claret_stem",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.WARPED_STEM).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block CLARET_HYPHAE = registerBlock("claret_hyphae",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.WARPED_HYPHAE).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block STRIPPED_CLARET_STEM = registerBlock("stripped_claret_stem",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_WARPED_STEM).sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block STRIPPED_CLARET_HYPHAE = registerBlock("stripped_claret_hyphae",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_WARPED_HYPHAE).sounds(BlockSoundGroup.NETHER_STEM)));
    public static final Block CLARET_PLANKS = registerBlock("claret_planks",
            new Block(FabricBlockSettings.of().strength(2.0f, 3.0f).sounds(BlockSoundGroup.NETHER_WOOD)));

    public static final Block CLARET_SLAB = registerBlock("claret_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.CLARET_PLANKS).sounds(BlockSoundGroup.NETHER_WOOD)));
    ...
    public static final Block CLARET_STAIRS = registerBlock("claret_stairs",
            new ModStairsBlock(ModBlocks.CLARET_PLANKS.getDefaultState(),
                    FabricBlockSettings.copyOf(ModBlocks.CLARET_PLANKS).sounds(BlockSoundGroup.NETHER_WOOD)));

    public static final Block CLARET_FENCE = registerBlock("claret_fence",
            new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.CLARET_PLANKS).sounds(BlockSoundGroup.NETHER_WOOD)));

    public static final Block CLARET_FENCE_GATE = registerBlock("claret_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(ModBlocks.CLARET_PLANKS).sounds(BlockSoundGroup.NETHER_WOOD), WoodType.CRIMSON));

    public static final Block CLARET_DOOR = registerBlock("claret_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.WARPED_DOOR).sounds(BlockSoundGroup.NETHER_WOOD), BlockSetType.CRIMSON));

    public static final Block CLARET_TRAPDOOR = registerBlock("claret_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.WARPED_TRAPDOOR).sounds(BlockSoundGroup.NETHER_WOOD), BlockSetType.CRIMSON));

    public static final Block CLARET_BUTTON = registerBlock("claret_button",
            new ButtonBlock(FabricBlockSettings.of().noCollision().strength(0.5f).sounds(BlockSoundGroup.NETHER_WOOD), BlockSetType.CRIMSON, 30, true));
    ...
    public static final Block EXPLOSIVE_SCORIA = registerBlock("explosive_scoria",
            new ExplosiveScoriaBlock(FabricBlockSettings.of().strength(3.0f,0.2f).requiresTool().sounds(BlockSoundGroup.NETHER_ORE)));
    ...
    public static final Block IGNEOUS_VINES_PLANT = registerBlockWithoutItem("igneous_vines_plant",
            new IgneousVinesPlantBlock(FabricBlockSettings.of().noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES)));

    public static final Block SMOKESTALK = registerBlock("smokestalk",
            new SmokestalkBlock(FabricBlockSettings.of().ticksRandomly().breakInstantly().sounds(ModSoundEvents.SMOKESTALK)));

    public static final Block SMOKESTALK_PLANT = registerBlockWithoutItem("smokestalk_plant",
            new SmokestalkPlantBlock(FabricBlockSettings.of().breakInstantly().sounds(ModSoundEvents.SMOKESTALK)));

    // Smokestalk Woodset

    public static final Block SMOKESTALK_BLOCK = registerBlock("smokestalk_block",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.WARPED_STEM).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block STRIPPED_SMOKESTALK_BLOCK = registerBlock("stripped_smokestalk_block",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_WARPED_STEM).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block SMOKESTALK_PLANKS = registerBlock("smokestalk_planks",
            new Block(FabricBlockSettings.of().strength(2.0f, 3.0f).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block SMOKESTALK_SLAB = registerBlock("smokestalk_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SMOKESTALK_PLANKS).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block SMOKESTALK_STAIRS = registerBlock("smokestalk_stairs",
            new ModStairsBlock(ModBlocks.CLARET_PLANKS.getDefaultState(),
                    FabricBlockSettings.copyOf(ModBlocks.SMOKESTALK_PLANKS).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block SMOKESTALK_FENCE = registerBlock("smokestalk_fence",
            new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.SMOKESTALK_PLANKS).sounds(ModSoundEvents.SMOKESTALK_WOOD)));

    public static final Block SMOKESTALK_FENCE_GATE = registerBlock("smokestalk_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(ModBlocks.SMOKESTALK_PLANKS).sounds(ModSoundEvents.SMOKESTALK_WOOD), WoodType.BAMBOO));

    public static final Block SMOKESTALK_DOOR = registerBlock("smokestalk_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.WARPED_DOOR).sounds(ModSoundEvents.SMOKESTALK_WOOD), BlockSetType.BAMBOO));

    public static final Block SMOKESTALK_TRAPDOOR = registerBlock("smokestalk_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.WARPED_TRAPDOOR).sounds(ModSoundEvents.SMOKESTALK_WOOD), BlockSetType.BAMBOO));

    public static final Block SMOKESTALK_BUTTON = registerBlock("smokestalk_button",
            new ButtonBlock(FabricBlockSettings.of().noCollision().strength(0.5f).sounds(BlockSoundGroup.NETHER_WOOD), BlockSetType.BAMBOO, 30, true));
    ...
    public static final Block QUARTZ_CRYSTAL = registerBlock("quartz_crystal",
            new AmethystClusterBlock(7, 3, FabricBlockSettings.of().nonOpaque().strength(1.5f).sounds(ModSoundEvents.QUARTZ_CRYSTAL)));

    public static final Block QUARTZ_CRYSTAL_BLOCK = registerBlock("quartz_crystal_block",
            new PillarBlock(FabricBlockSettings.of().strength(2.5f).requiresTool().sounds(ModSoundEvents.QUARTZ_CRYSTAL)));
    ...
    public static final Block CHISELED_QUARTZ_PILLAR = registerBlock("chiseled_quartz_pillar",
            new ModFacingBlock(FabricBlockSettings.copyOf(Blocks.QUARTZ_PILLAR)));

    // Silica Sandstone

    public static final Block SILICA_SAND = registerBlock("silica_sand",
            new SandBlock(8812140, FabricBlockSettings.of().strength(0.4f).sounds(BlockSoundGroup.SAND)));

    public static final Block SILICA_SANDSTONE = registerBlock("silica_sandstone",
            new Block(FabricBlockSettings.of().strength(1.0f).requiresTool()));

    public static final Block SILICA_SANDSTONE_SLAB = registerBlock("silica_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SILICA_SANDSTONE)));
    ...
    public static final Block SMOOTH_SILICA_SANDSTONE_STAIRS = registerBlock("smooth_silica_sandstone_stairs",
            new ModStairsBlock(ModBlocks.SMOOTH_SILICA_SANDSTONE.getDefaultState(),
                    FabricBlockSettings.copyOf(ModBlocks.SMOOTH_SILICA_SANDSTONE)));

    // Nether Bricks

    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));

    public static final Block RED_MIXED_NETHER_BRICKS = registerBlock("red_mixed_nether_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    public static final Block BLUE_NETHER_BRICKS = registerBlock("blue_nether_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));

    public static final Block BLUE_NETHER_BRICK_SLAB = registerBlock("blue_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.BLUE_NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    public static final Block BLUE_NETHER_BRICK_STAIRS = registerBlock("blue_nether_brick_stairs",
            ...
            FabricBlockSettings.copyOf(ModBlocks.BLUE_NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));

    public static final Block BLUE_NETHER_BRICK_WALL = registerBlock("blue_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(ModBlocks.BLUE_NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));

    // Pyrite

    public static final Block PYRITE_BLOCK = registerBlock("pyrite_block",
            new Block(FabricBlockSettings.of().strength(3.5f,6.5f).requiresTool().sounds(BlockSoundGroup.COPPER)));

    public static final Block PYRITE_SLAB = registerBlock("pyrite_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.PYRITE_BLOCK).sounds(BlockSoundGroup.COPPER)));
    ...
    public static final Block PYRITE_STAIRS = registerBlock("pyrite_stairs",
            new ModStairsBlock(ModBlocks.PYRITE_BLOCK.getDefaultState(),
                    FabricBlockSettings.copyOf(ModBlocks.PYRITE_BLOCK).sounds(BlockSoundGroup.COPPER)));

    public static final Block PYRITE_WALL = registerBlock("pyrite_wall",
            new WallBlock(FabricBlockSettings.copyOf(ModBlocks.PYRITE_BLOCK).sounds(BlockSoundGroup.COPPER)));

    public static final Block PYRITE_BUTTON = registerBlock("pyrite_button",
            new ButtonBlock(FabricBlockSettings.of().noCollision().strength(1f).sounds(BlockSoundGroup.COPPER), BlockSetType.STONE, 10, false));

    public static final Block MEDIUM_WEIGHTED_PRESSURE_PLATE = registerBlock("medium_weighted_pressure_plate",
            new WeightedPressurePlateBlock(75, FabricBlockSettings.of().noCollision().strength(1f).sounds(BlockSoundGroup.METAL), BlockSetType.IRON));

    public static final Block PYRITE_LANTERN = registerBlock("pyrite_lantern",
            new PillarBlock(FabricBlockSettings.copyOf(ModBlocks.PYRITE_BLOCK).strength(0.4f).luminance(15).sounds(BlockSoundGroup.LANTERN)));

    public static final Block SOUL_PYRITE_LANTERN = registerBlock("soul_pyrite_lantern",
            new PillarBlock(FabricBlockSettings.copyOf(ModBlocks.PYRITE_LANTERN).luminance(10).sounds(BlockSoundGroup.LANTERN)));

    public static final Block PYRITE_CHAIN = registerBlock("pyrite_chain",
            new ChainBlock(FabricBlockSettings.of().strength(3.5f,6.5f).requiresTool().nonOpaque().sounds(BlockSoundGroup.CHAIN)));

    public static final Block PYRITE_NETHER_BRICKS = registerBlock("pyrite_nether_bricks",
            new RotatingBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    */
    ...
    public static final Block SHROOMNIGHT = registerBlock("shroomnight",
            new Block(FabricBlockSettings.copyOf(Blocks.SHROOMLIGHT).luminance(9).sounds(BlockSoundGroup.SHROOMLIGHT)));

    public static final Block NETHER_WART_BEARD = registerBlock("nether_wart_beard",
            new BeardBlock(FabricBlockSettings.of().breakInstantly().noCollision().sounds(BlockSoundGroup.WART_BLOCK)));
    ...
    public static final Block WEEPING_IVY = registerBlockWithoutItem("weeping_ivy",
            new WeepingIvyBlock(FabricBlockSettings.of().breakInstantly().noCollision().ticksRandomly().sounds(BlockSoundGroup.WEEPING_VINES)));

    public static final Block TWISTING_IVY = registerBlockWithoutItem("twisting_ivy",
            new TwistingIvyBlock(FabricBlockSettings.of().breakInstantly().noCollision().ticksRandomly().sounds(BlockSoundGroup.WEEPING_VINES)));
    ...
    public static final Block CRIMSON_SPROUTS = registerBlock("crimson_sprouts",
            new SproutsBlock(FabricBlockSettings.copyOf(Blocks.NETHER_SPROUTS).sounds(BlockSoundGroup.NETHER_SPROUTS)));

    public static final Block SOUL_SOIL_LAYER = registerBlock("soul_soil_layer",
            new SoulSoilLayerBlock(FabricBlockSettings.of().strength(0.5f)
    ...
    public static final Block SOUL_PATH = registerBlock("soul_path",
            new SoulPathBlock(FabricBlockSettings.copyOf(Blocks.DIRT_PATH).strength(0.5f).sounds(BlockSoundGroup.SOUL_SOIL)));

    public static final Block CRIMSON_NYLIUM_PATH = registerBlock("crimson_nylium_path",
            new NyliumPathBlock(FabricBlockSettings.copyOf(Blocks.DIRT_PATH).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NYLIUM)));
    ...
    public static final Block CRIMSON_SPORESHROOM = registerBlock("crimson_sporeshroom",
            new SporeshroomBlock(FabricBlockSettings.of().strength(0.5f).sounds(BlockSoundGroup.FUNGUS),ModParticles.CRIMSON_SMOG, ParticleTypes.CRIMSON_SPORE, ModTags.Biomes.HAS_CRIMSON_SPORES));

    public static final Block WARPED_SPORESHROOM = registerBlock("warped_sporeshroom",
            new SporeshroomBlock(FabricBlockSettings.of().strength(0.5f).sounds(BlockSoundGroup.FUNGUS),ModParticles.WARPED_SMOG, ParticleTypes.WARPED_SPORE, ModTags.Biomes.HAS_WARPED_SPORES));
