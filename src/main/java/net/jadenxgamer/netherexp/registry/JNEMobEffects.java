...
public class JNEMobEffects {
    ...
    public static final Supplier<MobEffect> UNBOUNDED_SPEED = MOB_EFFECTS.register("unbounded_speed", () ->
            new JNEMobEffect(MobEffectCategory.BENEFICIAL, 1787717));

    public static final Supplier<MobEffect> BETRAYED = MOB_EFFECTS.register("betrayed", () ->
    ...
    public static final Supplier<MobEffect> SPEED_IMMUNITY = MOB_EFFECTS.register("speed_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "speed")));

    public static final Supplier<MobEffect> SLOWNESS_IMMUNITY = MOB_EFFECTS.register("slowness_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "slowness")));

    public static final Supplier<MobEffect> STRENGTH_IMMUNITY = MOB_EFFECTS.register("strength_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "strength")));

    public static final Supplier<MobEffect> JUMP_BOOST_IMMUNITY = MOB_EFFECTS.register("jump_boost_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "jump_boost")));

    public static final Supplier<MobEffect> REGENERATION_IMMUNITY = MOB_EFFECTS.register("regeneration_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "regeneration")));

    public static final Supplier<MobEffect> FIRE_RESISTANCE_IMMUNITY = MOB_EFFECTS.register("fire_resistance_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "fire_resistance")));

    public static final Supplier<MobEffect> WATER_BREATHING_IMMUNITY = MOB_EFFECTS.register("water_breathing_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "water_breathing")));

    public static final Supplier<MobEffect> INVISIBILITY_IMMUNITY = MOB_EFFECTS.register("invisibility_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "invisibility")));

    public static final Supplier<MobEffect> WEAKNESS_IMMUNITY = MOB_EFFECTS.register("weakness_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "weakness")));

    public static final Supplier<MobEffect> POISON_IMMUNITY = MOB_EFFECTS.register("poison_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "poison")));

    public static final Supplier<MobEffect> RESISTANCE_IMMUNITY = MOB_EFFECTS.register("resistance_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "resistance")));

    public static final Supplier<MobEffect> ABSORPTION_IMMUNITY = MOB_EFFECTS.register("absorption_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "absorption")));

    public static final Supplier<MobEffect> HASTE_IMMUNITY = MOB_EFFECTS.register("haste_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "haste")));

    public static final Supplier<MobEffect> MINING_FATIGUE_IMMUNITY = MOB_EFFECTS.register("mining_fatigue_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "mining_fatigue")));

    public static final Supplier<MobEffect> DARKNESS_IMMUNITY = MOB_EFFECTS.register("darkness_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "darkness")));

    public static final Supplier<MobEffect> LEVITATION_IMMUNITY = MOB_EFFECTS.register("levitation_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "levitation")));

    public static final Supplier<MobEffect> HUNGER_IMMUNITY = MOB_EFFECTS.register("hunger_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "hunger")));

    public static final Supplier<MobEffect> WITHER_IMMUNITY = MOB_EFFECTS.register("wither_immunity", () ->
            new ImmunityEffect(MobEffectCategory.BENEFICIAL, NetherExp.idPath("minecraft", "wither")));

    public static final Supplier<MobEffect> LUCK_IMMUNITY = MOB_EFFECTS.register("luck_immunity", () ->
            new ImmunityEffect(MobEffectCategory.HARMFUL, NetherExp.idPath("minecraft", "luck")));

    public static final Supplier<MobEffect> UNLUCK_IMMUNITY = MOB_EFFECTS.register("unluck_immunity", () ->
