...
public class HugeFungusNetherExpFeature extends Feature<HugeFungusFeatureConfig> {

    public HugeFungusNetherExpFeature(Codec<HugeFungusFeatureConfig> codec) {
        super(codec);
    }
    ...
    private static void generateVines(BlockPos pos, WorldAccess world, Random random) {
        ...
        if (world.isAir(mutable)) {
            ...
            WeepingVinesNetherExpFeature.generateVineColumn(world, random, mutable, i, 23, 25);
        }
    }
}
